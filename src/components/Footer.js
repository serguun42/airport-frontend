    ...
    <footer className="footer">
      ...
      <section className="footer__section">
        <div className="footer__section__item">
          ...
          <a href="https://github.com/serguun42/airport-frontend" target="_blank" rel="noopener noreferrer">
            Github / Frontend
          </a>
        </div>
        ...
        <div className="footer__section__item">
          ...
          <a href="https://github.com/serguun42/airport-enhanced" target="_blank" rel="noopener noreferrer">
            Github / Android App
          </a>
        </div>
        ...
        <div className="footer__section__item default-pointer">
          <i className="material-icons">api</i>
          <Link to="/docs/api/redoc.html" target="_blank" rel="noopener noreferrer">
            Redoc API
          </Link>
        </div>
      </section>
